...
export default function UpdateAdminForm({ user, close }: Props) {
    ...
    const onSubmit = async (data: IUser) => {
        ...
        try {
            ...
            await Swal.fire({ title: "¡Actualizado!", text: "Datos guardados correctamente.", icon: "success", timer: 2000, showConfirmButton: false, confirmButtonColor: "#2dbda1" });
            close();
        } catch {
    ...
    return (
        <FormModal title="Editar Perfil" subtitle="Administrador" accentColor="#e54a55" onClose={close}>
